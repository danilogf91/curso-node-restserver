...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"test.js":[function(require,module,exports) {
"use strict";
...
var btnAnterior = document.querySelector(".btnAnterior");
if (btnSiguiente) btnSiguiente.addEventListener("click", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (Url === undefined) {
              Url = "".concat(window.location.href, "?limite=4&desde=0");
            }

            console.log(Url);
            alert("Hola siguiente " + Url);
            _context.next = 7;
            return siguiente(Url);
...
if (btnAnterior) btnAnterior.addEventListener("click", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            Url = window.location.href.split("?")[1];
            console.log(Url);
            alert("Hola anterior " + Url); //await siguiente(Url);
...
var siguiente = /*#__PURE__*/function () {
